...
namespace QuarryCo
{
    public class Building_Quarry : Building
    {
        ...
        private void PickResource(out ThingDef def, out int amount)
        {
            ...
            {
                // Omega: stone 6%, steel 37%, gold 10%, jade 10%, plasteel 10%, uranium 10%, components 8%, silver 9%
                if (roll < 0.37f)
                {
                ...
                {
                    def = ThingDefOf.Gold;
                    amount = Rand.RangeInclusive(8, 18);
                    return;
                }
                if (roll < 0.57f)
                {
                ...
                if (roll < 0.67f)
                {
                    ...
                    amount = Rand.RangeInclusive(12, 24);
                    return;
                }
                if (roll < 0.77f)
                {
                ...
                if (roll < 0.85f)
                {
                    ...
                    amount = Rand.RangeInclusive(4, 6);
                    return;
                }
                if (roll < 0.94f)
                {
                    def = ThingDefOf.Silver;
                    amount = Rand.RangeInclusive(25, 50);
                    return;
                }
            }
            else if (Size == QuarrySize.Titan)
            {
                // Titan: stone 11%, steel 32%, slag 5%, silver 10%, gold 9%, jade 9%, plasteel 9%, uranium 8%, components 7%
                if (roll < 0.32f)
                {
                    def = ThingDefOf.Steel;
                    amount = Rand.RangeInclusive(25, 50);
                ...
                {
                    def = ThingDefOf.Uranium;
                    amount = Rand.RangeInclusive(8, 14);
                    return;
                }
                if (roll < 0.74f)
                {
                    def = ThingDefOf.ComponentIndustrial;
                    amount = Rand.RangeInclusive(3, 5);
                    return;
                }
                if (roll < 0.84f)
                {
            ...
            {
                // Colossal: stone 16%, steel 27%, slag 8%, silver 12%, gold 8%, jade 8%, plasteel 8%, uranium 7%, components 6%
                if (roll < 0.27f)
                {
                    def = ThingDefOf.Steel;
                    amount = Rand.RangeInclusive(18, 35);
                    return;
                }
                if (roll < 0.35f)
                {
                ...
                {
                    def = ThingDefOf.Silver;
                    amount = Rand.RangeInclusive(12, 30);
                    return;
                }
                if (roll < 0.84f)
                {
