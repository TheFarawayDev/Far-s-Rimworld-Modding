...
# 2. Setup folders
$modDir = "c:\Users\meast\Downloads\Development\GAMES\rimworldModding\SmartPriorities"
...
# 4. Compile SmartPriorities.dll
Write-Host "Compiling SmartPriorities..." -ForegroundColor Green
...
$outputDll = "$assembliesDir\SmartPriorities.dll"
...
Write-Host "Successfully compiled SmartPriorities.dll!" -ForegroundColor Green

# 5. Deploy mod to RimWorld Mods folder
$deployDir = "$GamePath\Mods\SmartPriorities"
...
# Copy assemblies
Copy-Item "$assembliesDir\SmartPriorities.dll" "$deployDir\1.6\Assemblies\" -Force
...
Write-Host "SmartPriorities mod deployed successfully!" -ForegroundColor Green
