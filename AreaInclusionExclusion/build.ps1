...
# 2. Setup folders
$modDir = "c:\Users\meast\Downloads\Development\GAMES\rimworldModding\AreaInclusionExclusion"
...
Write-Host "Compiling AreaInclusionExclusion..." -ForegroundColor Green
...
$outputDll = "$assembliesDir\AreaInclusionExclusion.dll"
...
Write-Host "Successfully compiled AreaInclusionExclusion.dll!" -ForegroundColor Green

# 5. Deploy mod to RimWorld Mods folder
$deployDir = "$GamePath\Mods\AreaInclusionExclusion"
